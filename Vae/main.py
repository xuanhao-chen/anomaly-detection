...
import torch
import numpy as np
from Vae.data_utils import *
from Vae.options import Options
...
def anomaly_detection(data_type):
    ...
    with open('./VAE_detection_results_' + str(data_type) +'.txt', 'w') as f:
        ...
        for file in files:
            ...
            model = VAE(opt, train_data, val_data, test_data, test_label, device)
