...
class Options():
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--window_size', type=int, default=320, help='input sequence size.')
        ...
        self.parser.add_argument('--folder', type=str, default='machine-1-1.pkl', help='folder index 0-4')
